  ...
  >
    <VCard>
      ...
      <VCardText>
        ...
        <VAlert
          v-if="confirmationOptions.destructive"
          type="warning"
          variant="tonal"
          class="mb-2"
        >
      ...
      <VCardActions>
        ...
        <VBtn
          ...
          :color="confirmationOptions.severity === 'error' ? 'error' : (confirmationOptions.severity === 'warning' ? 'warning' : 'primary')"
...
function getConfirmText(): string {
  switch (props.actionType) {
    ...
    case 'save-draft': return 'Save Draft'
...
const computedVariant = computed(() => {
  switch (props.variant) {
    case 'primary':
    case 'approve': return 'elevated'
    case 'secondary': return 'flat'
    case 'reject':
    case 'warning': return 'flat'
